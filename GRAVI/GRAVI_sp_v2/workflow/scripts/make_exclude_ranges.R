...
# since the original line timedout when running inside Slurm, from interactive R in right conda env, run the following
#library(AnnotationHub)
#ah <- AnnotationHub()
#saveRDS(ah, "output/annotation/annotationhub.rds") 
ah <- readRDS(here::here("output/annotations/annotationhub.rds")) #load pre-saved file 
#ah <- AnnotationHub() #original line, timedout in Slurm
